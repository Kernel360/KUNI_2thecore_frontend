...
const API_BASE_URL =
  import.meta.env.VITE_CAR_BASE_URL || 'httpss://43.203.110.104:8080/api';
const EMULATOR_API_BASE_URL =
  import.meta.env.VITE_EMULATOR_BASE_URL || 'httpss://3.37.93.107:8081/api';
const ANALYSIS_API_BASE_URL =
  import.meta.env.VITE_ANALYSIS_API_BASE_URL || 'httpss://54.180.89.182:5000/api';
